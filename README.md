# btkhdl
# Hệ Thống Phát Hiện Giao Dịch Bất Thường (Fraud & Anomaly Detection Web App)
...
- **Tải tệp dữ liệu tùy chỉnh:** Cho phép người dùng kéo thả hoặc tải lên các file dữ liệu giao dịch định dạng `.csv, .xlsx`.
